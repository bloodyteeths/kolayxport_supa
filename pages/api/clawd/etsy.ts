            ...
            const formattedReceipts = receipts.map((receipt: any) => {
                ...
                return {
                    ...
                    shipping_address: {
                        ...
                        zip: receipt.zip || '',
                        country: (typeof receipt.country_iso === 'string' && receipt.country_iso.trim()) ? receipt.country_iso.trim().toUpperCase() : (receipt.first_line || receipt.city || receipt.zip ? 'US' : ''),
        ...
        if (req.method === 'GET' && action === 'receipt' && receipt_id) {
            ...
            const formatted: EtsyReceipt = {
                ...
                shipping_address: {
                    ...
                    state: receipt.state || null,
                    zip: receipt.zip || '',
                    country_iso: (typeof receipt.country_iso === 'string' && receipt.country_iso.trim()) ? receipt.country_iso.trim().toUpperCase() : (receipt.first_line || receipt.city || receipt.zip ? 'US' : ''),
                    formatted_address: receipt.formatted_address || '',
                },
                items,
