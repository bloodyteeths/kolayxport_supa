...
const GROUP_ICONS: Record<string, React.ReactNode> = {
  ...
  'Anne & Bebek & Çocuk': <Baby size={16} />,
  'Ayakkabı': <ShoppingBag size={16} />,
  'Bahçe & Elektrikli El Aletleri': <Wrench size={16} />,
  'Banyo Yapı & Hırdavat': <Hammer size={16} />,
  'Ek Hizmetler': <Package size={16} />,
  'Elektronik': <Smartphone size={16} />,
  'Ev & Mobilya': <Home size={16} />,
  'Giyim': <Shirt size={16} />,
  'Hobi & Eğlence': <Gamepad2 size={16} />,
  'Kırtasiye & Ofis Malzemeleri': <Pencil size={16} />,
  'Kitap': <BookOpen size={16} />,
  'Kozmetik & Kişisel Bakım': <Sparkles size={16} />,
  'Otomobil & Motosiklet': <Car size={16} />,
  'Spor & Outdoor': <Dumbbell size={16} />,
  'Süpermarket': <Store size={16} />,
};
