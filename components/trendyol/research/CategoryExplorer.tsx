...
const GROUP_ICONS: Record<string, React.ReactNode> = {
  ...
  'Anne & Bebek & Çocuk': <Baby size={14} />,
  'Ayakkabı': <ShoppingCart size={14} />,
  'Bahçe & Elektrikli El Aletleri': <Wrench size={14} />,
  'Banyo Yapı & Hırdavat': <Hammer size={14} />,
  'Ek Hizmetler': <Package size={14} />,
  'Elektronik': <Smartphone size={14} />,
  'Ev & Mobilya': <Home size={14} />,
  'Giyim': <Shirt size={14} />,
  'Hobi & Eğlence': <Gamepad2 size={14} />,
  'Kırtasiye & Ofis Malzemeleri': <Pencil size={14} />,
  'Kitap': <BookOpen size={14} />,
  'Kozmetik & Kişisel Bakım': <Sparkles size={14} />,
  'Otomobil & Motosiklet': <Car size={14} />,
  'Spor & Outdoor': <Dumbbell size={14} />,
  'Süpermarket': <Store size={14} />,
};

const GROUP_COLORS: Record<string, string> = {
  'Aksesuar': '#e91e63',
  'Anne & Bebek & Çocuk': '#4caf50',
  'Ayakkabı': '#795548',
  'Bahçe & Elektrikli El Aletleri': '#607d8b',
  'Banyo Yapı & Hırdavat': '#9e9e9e',
  'Ek Hizmetler': '#78909c',
  'Elektronik': '#2196f3',
  'Ev & Mobilya': '#667eea',
  'Giyim': '#f44336',
  'Hobi & Eğlence': '#ff9800',
  'Kırtasiye & Ofis Malzemeleri': '#00bcd4',
  'Kitap': '#8bc34a',
  'Kozmetik & Kişisel Bakım': '#9c27b0',
