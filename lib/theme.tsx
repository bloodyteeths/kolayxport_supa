...
const theme = createTheme({
  ...
  typography: {
    ...
    h2: { fontSize: '1.75rem', fontWeight: 700, letterSpacing: '-0.025em', lineHeight: 1.3 },
    h3: { fontSize: '1.375rem', fontWeight: 600, letterSpacing: '-0.02em', lineHeight: 1.4 },
    h4: { fontSize: '1.25rem', fontWeight: 600, letterSpacing: '-0.02em', lineHeight: 1.4 },
    h5: { fontSize: '1.125rem', fontWeight: 600, letterSpacing: '-0.01em' },
    h6: { fontSize: '1rem', fontWeight: 600, letterSpacing: '-0.01em' },
    subtitle1: { fontSize: '1.0625rem', fontWeight: 500, color: '#64748b' },
    subtitle2: { fontSize: '0.9375rem', fontWeight: 500, color: '#64748b' },
    body1: { fontSize: '1rem', lineHeight: 1.6 },
    body2: { fontSize: '0.9rem', lineHeight: 1.5 },
    button: { fontWeight: 600, letterSpacing: '0.01em' },
    caption: { fontSize: '0.825rem', color: '#94a3b8' },
    overline: { fontSize: '0.775rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase' as const },
  },
  shape: {
    borderRadius: 12,
  },
