                  ...
                  <div className="space-y-6">
                    ...
                    <Step number="2" title="Eklentiyi Chrome'a Yükleyin">
                      ...
                      <ol className="list-decimal list-inside space-y-2 text-sm mt-3">
                        <li>İndirdiğiniz <code className="bg-gray-100 px-2 py-1 rounded">kolayxport-etsy-chrome-extension.zip</code> dosyasını bilgisayarınızda uygun bir yere çıkarın</li>
